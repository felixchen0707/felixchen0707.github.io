...
// <div class='checkbox color checked'><input type="checkbox" checked="checked"/>
            <p>text</p>
            </div>
...
//ghbdage.js
/*<object class="ghbdage" style="margin-inline:5px" title="[title]" standby="loading..." data="https://img.shields.io/badge/left-right-orange?logo=[logo]&color=[color]&link=[link]&option"></object>*/
...
//issues.js
// 从 issues 加载动态数据
// <div class="issues-api sites/timeline/friends"api="xxx"group="key:a,b,c"></div>
// 例如：
// <div class="issues-api sites"api="https://api.github.com/repos/volantis-x/examples/issues?sort=updated&state=open&page=1&per_page=100"group="version:latest,v6,v5,v4,v3,v2,v1,v0"></div>
...
//link.js
// <div class="tag link"><a class="link-card" title="title" href="url"><div class="left"><img src="/img/link.png"/></div><div class="right"><p class="text">title</p><p class="url">url</p></div></a></div>
// <div class="tag link"><a class="link-card" title="title" href="url"><div class="left"><img src="img"/></div><div class="right"><p class="text">title</p><p class="url">url</p></div></a></div>
...
// <span class='nota' data-nota='注释内容，使用逗号间隔开了即可'>注释词汇</span>
...
/**
 * bubble
 * <span class="bubble-content">content</span><span class="bubble-notation"><span class="bubble-item" style="background-color:background-color];">notation[</span></span>
 */

//reference.js

/*
<span class="hidden-anchor" id="referto_id"></span><sup class="reference"><a href="#referfrom_id">id</a></sup><span class="reference-bubble"><span class="reference-item"><span class="reference-literature">literature</span><span class="reference-title">参考资料</span></span></span>
<div class="reference-source"><span class="hidden-anchor" id="referfrom_id"></span><a class="reference-anchor" href="#referto_id">id<div class="reference-anchor-up fa-solid fa-angles-up"></div></a><a class="reference-link" href="/url">literature</a></div>
*/
